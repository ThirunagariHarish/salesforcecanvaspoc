...
%>This App must be invoked via a signed
request!<%
	return;
	}
...
<link rel="stylesheet" type="text/css"
	href="/examples/chatter-talk/talk.css" />
...
<script type="text/javascript"
	src="/examples/chatter-talk/chatter-talk.js"></script>
		...
		<div id="stylized" class="flex hbox boxcenter">
			...
			<div style="height: 100px; text-align: center">
				...
				<p style="display: none">
					Speech input is not enabled in your browser.<br> Try running
					Google Chrome with the
					<code>--enable-speech-input</code>
					flag.
				</p>
			</div>
			<div style="height: 50px; text-align: center">
